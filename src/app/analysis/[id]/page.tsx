        ...
        <section className="space-y-6 pt-8 border-t border-border/50">
          ...
          <div className="grid grid-cols-1 md:grid-cols-3 gap-4">
            <div className="p-4 bg-emerald-500/10 border border-emerald-500/20 rounded">
              <h4 className="text-xs font-mono text-emerald-500 uppercase mb-1">
                Entry Zone
              </h4>
            ...
            <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-3 gap-2">
              {analysis.sources.map((source, idx) => (
                <a
                  ...
                  target="_blank"
                  rel="noopener noreferrer"
                  className="group flex items-start gap-2 p-3 bg-card border border-border rounded hover:border-primary/50 transition-colors"
                >
                  ...
                  <div className="min-w-0">
                    ...
                    <span
                      className={`inline-block mt-1 text-[9px] font-mono uppercase px-1.5 py-0.5 rounded ${
                        source.section === "movement"
                          ? "bg-blue-500/10 text-blue-400"
                          : source.section === "fundamentals"
                            ? "bg-emerald-500/10 text-emerald-400"
                            : source.section === "priceTargets"
